...
public class ContactsDatabase {
  ...
  private static final String CONTACT_MIMETYPE = "vnd.android.cursor.item/vnd." + BuildConfig.APPLICATION_ID + ".contact";
  private static final String CALL_MIMETYPE    = "vnd.android.cursor.item/vnd." + BuildConfig.APPLICATION_ID + ".call";
