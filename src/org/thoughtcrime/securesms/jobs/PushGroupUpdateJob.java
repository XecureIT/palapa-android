...
public class PushGroupUpdateJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    List<SignalServiceAddress> admins = new LinkedList<>();

    for (RecipientId admin : record.get().getAdmins()) {
      Recipient recipient = Recipient.resolved(admin);
      admins.add(RecipientUtil.toSignalServiceAddress(context, recipient));
    }
