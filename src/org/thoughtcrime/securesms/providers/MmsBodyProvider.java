...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://" + BuildConfig.APPLICATION_ID + ".provider.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI(BuildConfig.APPLICATION_ID + ".provider.mms", "mms/#", SINGLE_ROW);
  }
