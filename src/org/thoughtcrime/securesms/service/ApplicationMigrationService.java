    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = BuildConfig.APPLICATION_ID + ".ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = BuildConfig.APPLICATION_ID + ".ApplicationMigrationService.COMPLETED";
