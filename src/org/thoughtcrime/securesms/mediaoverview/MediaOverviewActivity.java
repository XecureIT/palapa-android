...
public final class MediaOverviewActivity extends PassphraseRequiredActionBarActivity {
  ...
  public static Intent forAllFromMain(@NonNull Context context) {
    Intent intent = forThread(context, MediaDatabase.ALL_THREADS);
  ...
  protected void onCreate(Bundle bundle, boolean ready) {
    ...
    viewPager.setCurrentItem(allThreads && !main ? 3 : 0);
  }
