...
public class SignalServiceGroup {
  ...
  private final Optional<List<SignalServiceAddress>> admins;
  ...
  public SignalServiceGroup(Type type, byte[] groupId, String name,
                            ...
                            SignalServiceAttachment avatar, String owner, List<SignalServiceAddress> admins)
  {
    this.type    = type;
  ...
  public Optional<List<SignalServiceAddress>> getAdmins() {
    return admins;
  }
  ...
  public static class Builder {
    ...
    private List<SignalServiceAddress> admins;
    ...
    public Builder withAdmins(List<SignalServiceAddress> admins) {
      this.admins = admins;
      return this;
    }
    ...
    public SignalServiceGroup build() {
      ...
      if (type == Type.UPDATE && name == null && members == null && avatar == null && owner == null && admins == null) {
