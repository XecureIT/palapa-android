...
public class SignalServiceConfiguration {
  ...
  public SignalServiceConfiguration(SignalServiceUrl[] signalServiceUrls)
  {
    this(signalServiceUrls, new SignalCdnUrl[] {}, new SignalContactDiscoveryUrl[] {}, new SignalKeyBackupServiceUrl[] {}, new SignalStorageUrl[] {});
  }

  public SignalServiceConfiguration(SignalServiceUrl[] signalServiceUrls, SignalCdnUrl[] signalCdnUrls)  {
    this(signalServiceUrls, signalCdnUrls, new SignalContactDiscoveryUrl[] {}, new SignalKeyBackupServiceUrl[] {}, new SignalStorageUrl[] {});
  }
